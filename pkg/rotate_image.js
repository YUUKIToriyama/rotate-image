...
export class ImageConverter {
    ...
    static __wrap(ptr) {
        const obj = Object.create(ImageConverter.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_imageconverter_free(ptr);
    }
    /**
    * @param {HTMLCanvasElement} canvas
    * @returns {ImageConverter}
    */
    static from_canvas(canvas) {
        try {
            const ret = wasm.imageconverter_from_canvas(addBorrowedObject(canvas));
            return ImageConverter.__wrap(ret);
        } finally {
    ...
    */
    rotate(radian) {
        wasm.imageconverter_rotate(this.ptr, radian);
    }
    /**
    * @param {HTMLCanvasElement} canvas
    */
    to_canvas(canvas) {
        try {
            ...
            wasm.imageconverter_to_canvas(retptr, this.ptr, addBorrowedObject(canvas));
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('rotate_image_bg.wasm', import.meta.url);
    }
    const imports = getImports();
